...
export const ENV = {
    ...
    // Modelo antigo (descontinuado pela InfinitePay) - mantido para compatibilidade
    ...
    // Beds24 (calendário mestre + sync Airbnb via API)
    BEDS24_API_KEY: getEnv('BEDS24_API_KEY'),
    BEDS24_PROP_KEY: getEnv('BEDS24_PROP_KEY'),
    BEDS24_ROOM_ID: getEnv('BEDS24_ROOM_ID'),
}
